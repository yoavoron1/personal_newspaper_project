...
3. כתוב שני רמות תוכן בעברית לכל כתבה שבחרת: סיכום קצר לדף הבית וניתוח מעמיק לדף הכתבה
...
{{
  ...
  "articles": [
    {{
      ...
      "long_summary": "פסקה ראשונה: הקשר ורקע — מה קרה ולמה זה חשוב עכשיו (3-4 משפטים).\\n\\nפסקה שנייה: פירוט ומשמעות — הנתונים, הממצאים או הפרטים המרכזיים (3-4 משפטים).\\n\\nפסקה שלישית: מגמות ועתיד — לאן זה מוביל ומה ניתן לצפות (3-4 משפטים).",
      "personal_impact": "השפעה אישית: נתח כיצד חדשות זו משפיעה ספציפית על {user_name} — {family_info_input.strip()}. כתוב 2-3 משפטים שמחברים את הנושא לחיים, לניסיון ולתחומי העניין שלה באופן אישי ומוחשי.",
      "source_id": 3
    }}
  ]
}}
...
- personal_impact: אישי ומוחשי, מתייחס לפרופיל המשתמש הספציפי
